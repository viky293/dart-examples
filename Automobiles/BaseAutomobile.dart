...
class BaseAutomobile {
  ...
  Gearbox gearBox;
  Wheels wheels;
  BaseAutomobile(this.engine, this.gearBox, this.wheels, this.maxSpeed);
  getInfo() {
    ...
    print(
        'E: ${engineInfo['state']} \t S : $speed \t G:  ${gearboxInfo['type']} \t M: ${gearboxInfo['mode']} \t CG: ${gearboxInfo['currentGear']} \t F: ${engineInfo['fuelType']} \t W: ${wheelsInfo['driveType']} \t B: ${wheelsInfo['brakes']}');
  }
