import 'gearbox/modes/EcoMode.dart';
import 'gearbox/modes/NoDriveMode.dart';
import 'gearbox/modes/SportsMode.dart';
...
class BaseAutomobile {
  ...
  getInfo() {
    ...
    print(
        '$model = E: ${engineInfo['state']} \t S : $speed \t G:  ${gearboxInfo['type']} : ${gearboxInfo['driveModeName']} \t M: ${gearboxInfo['mode']} \t CG: ${gearboxInfo['currentGear']} \t F: ${engineInfo['fuelType']} \t W: ${wheelsInfo['driveType']} \t B: ${wheelsInfo['brakes']}');
  }
  ...
  driveModeSports() {
    gearBox.driveMode = SportsMode(maxSpeed);
  }

  driveModeEco() {
    gearBox.driveMode = EcoMode(maxSpeed);
  }

  driveModeNone() {
    gearBox.driveMode = NoDriveMode(0);
  }
