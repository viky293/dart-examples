...
This section is part 8 and aims to provide an example for the Composite pattern.

Goals of composite pattern are:-

- Allow to compose a bigger tree like structure, to represent part-whole hierarchies 
- Provide a similar interface for the client to treat each node/object in a similar fashion
  
Implementation in following :-

- [IGear.dart](./interface/IGear.dart) // Interface for the leaf nodes
- Leaf & Composite
  - [Gears](./gearbox/Gears.dart)
  - [Gear](./gearbox/Gear.dart)
- Client
  - [ManualTransmission](./gearbox/ManualTransmission.dart)

- [TuneUp](./TuneUp.dart) //Test 
