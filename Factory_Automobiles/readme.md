...
This section is part 2 and aims to provide an example for the simple Factory programming idiom. 

Simple factory isn't really a design pattern, it is good to understand it though.
It is one of those things that are simple and yet difficult to understand because we cannot stop questioning what's the real advantange of this and how does it actually help anyone? 

* Avoiding code duplication, following DRY principle
* Single place to
  *  add new types 
  *  perfrom pre and post object creation operations

Implementation here in [Highway.dart](./Highway.dart)
